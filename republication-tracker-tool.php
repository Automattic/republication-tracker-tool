<?php
/**
 * Plugin Name:     Republication Tracker Tool (final version, please migrate)
 ...
 */
function republication_tracker_tool_legacy_repo_notice() {
	if ( ! current_user_can( 'manage_options' ) ) {
		return;
	}
	?>
	<div class="notice notice-error">
		<p><strong><?php esc_html_e( 'You are running an outdated version of the Republication Tracker Tool plugin.', 'republication-tracker-tool' ); ?></strong></p>
		<p>
			<?php
			printf(
				wp_kses(
					/* translators: 1: URL of the announcement post. 2: URL of the download center. */
					__( 'This is the final version released from the legacy plugin repository, and it will not receive further updates. <a href="%1$s">Read the announcement</a>, then download the current version from the <a href="%2$s">Newspack download center</a>.', 'republication-tracker-tool' ),
					[
						'a' => [
							'href' => [],
						],
 ...
 */
add_action( 'all_admin_notices', 'republication_tracker_tool_legacy_repo_notice', -99999 );
